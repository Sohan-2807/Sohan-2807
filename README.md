...
<img src="https://github-readme-stats.vercel.app/api?username=Sohan-2807&show_icons=true&theme=tokyonight&hide_border=true&bg_color=050608&title_color=6F8FFF&icon_color=4169E1&text_color=c9d1d9&count_private=true&cache_seconds=1800" alt="GitHub Stats" height="165" />
<img src="https://streak-stats.demolab.com?user=Sohan-2807&theme=tokyonight&hide_border=true&background=050608&ring=4169E1&fire=6F8FFF&currStreakLabel=6F8FFF" alt="GitHub Streak" height="165" />

<img src="https://github-readme-stats.vercel.app/api/top-langs/?username=Sohan-2807&layout=compact&theme=tokyonight&hide_border=true&bg_color=050608&title_color=6F8FFF&text_color=c9d1d9&cache_seconds=1800" alt="Top Languages" height="165" />

</div>

> These three cards call a shared, well-maintained public endpoint (`github-readme-stats.vercel.app`, `streak-stats.demolab.com`). If GitHub renders a broken-image icon for any of them, it's almost always a **temporary rate-limit blip on their free server** — refreshing the page after a minute fixes it. For a card that never breaks, self-host the same project on your own free Vercel account (one-click deploy button on the [github-readme-stats repo](https://github.com/anuraghazra/github-readme-stats)) and swap the domain.

---

### Contribution Activity Graph & Snake (self-generated — guaranteed uptime)

<div align="center">
<img src="https://raw.githubusercontent.com/Sohan-2807/Sohan-2807/output/github-contribution-grid-snake-dark.svg" alt="Contribution Snake" width="90%" />
<br><br>
<img src="https://raw.githubusercontent.com/Sohan-2807/Sohan-2807/master/profile-metrics.svg" alt="Metrics: activity graph, streak, languages" width="90%" />
</div>

> Unlike the widgets above, these two images are **generated by GitHub Actions running inside your own repo** and committed as static SVG files — no external server, no rate limits, nothing that can go down. See the exact setup below (two YAML files, ~2 minutes).
...
<div align="center">
<img src="https://github-profile-trophy.vercel.app/?username=Sohan-2807&theme=tokyonight&no-frame=true&no-bg=true&row=1&margin-w=15&column=6" alt="GitHub Trophies" />
</div>

---

### Setting Up the Self-Generated Widgets (do this once — guarantees they work)

This README must live in a special repo named **exactly** `Sohan-2807/Sohan-2807` (create it if it doesn't exist — GitHub turns a repo named after your own username into your profile README). Then add these two files:

**1. `.github/workflows/snake.yml`** — generates the contribution snake on a schedule and pushes it to an `output` branch:
...
**2. `.github/workflows/metrics.yml`** — generates the activity graph, streak, and top languages as one static SVG committed straight to `main` (via [lowlighter/metrics](https://github.com/lowlighter/metrics), the actively maintained tool built for exactly this):
...
Commit both files, run each workflow once manually from the **Actions** tab (`workflow_dispatch`), and the two images in the section above will populate — and keep refreshing every 6 hours automatically, with zero dependency on any third-party server's uptime.

**Everything else needs no setup:**
- **Stats / Streak / Top Langs cards** — hosted, render on request; occasional broken-image icon is a temporary rate-limit blip on the free server (see note above), not a broken link.
- **Trophy case** — hosted via `github-profile-trophy.vercel.app`, renders on request.
- **Profile view counter** — live via `komarev.com/ghpvc`, tracks visits automatically.
